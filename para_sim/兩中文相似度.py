...
text1 = '/Users/Gavin/work/news_baijia_AI/para_sim/TextRank4ZH/text/01.txt'
text2 = '/Users/Gavin/work/news_baijia_AI/para_sim/TextRank4ZH/text/02.txt'
...
if __name__=="__main__":
    ...
    trainTokens = getTokensFromFile(text1)
    trainTokenFrequency = getTokenFreqList(trainTokens)
    
    # testFileName = sys.argv[2]
    testTokens = getTokensFromFile(text2)
