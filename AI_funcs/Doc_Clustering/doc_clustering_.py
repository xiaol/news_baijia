...
if __name__ == "__main__":
    doc_cluster([{1: '有媒体报道成都离职协警向3名女子强行注射不明液体，导致1人身亡。'},
                 {2: '成都一离职协警强行向女子注射不明液体致其死亡。'},
                 {3: '限娱令市场供过于求，明星上真人秀的根本原因还是电视节目需要，并非艺人一厢情愿地在找“出口”，而这种需要也让明星的身价顺势水涨船高。'},
                 {4: '限娱令市场供过于求，明星上真人秀的原因是节目需要更是源自观众窥私欲和虐星心态，正是这些原因让明星身价水涨船高。'}])
